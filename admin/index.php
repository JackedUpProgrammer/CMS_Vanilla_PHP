...
?>
                                    ...
                                    <?php  
                                    $element_text = ['All Posts','Drafted Post','Published Post', 'Comments','Unapproved Comments', 'Users','Subscribed User', 'Categories'];
                                    $element_count = [$post_count, $post_draft_count, $post_published_count, $comment_count,$unapproved_count, $user_count,$subscriber_count, $categories_count];
